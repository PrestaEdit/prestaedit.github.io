...
author: PrestaEdit
series: prestaflow
featuredimg: 'https://prestaedit.github.io/head/2026-08-28-prestaflow-scenarios-multi-locales.svg'
...
En CI, le pattern est identique à la matrice multi-versions de l'[article 2](/blog/automatiser-ses-scenarios-prestaflow-en-ci/) — on ajoute simplement une dimension :
