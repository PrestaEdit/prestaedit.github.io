...
1. **Créer un compte** sur [prestaflow.io](https://prestaflow.io) puis un projet pour votre module. La plateforme vous fournit un **projectId** de la forme `pk_01ABCDEF...`.
