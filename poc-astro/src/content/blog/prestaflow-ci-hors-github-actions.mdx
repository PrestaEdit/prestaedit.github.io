...
summary: >-
  L'article 2 a couvert GitHub Actions. Le niveau 1 (CLI dans un workflow, sans
  plateforme) s'adapte aux autres CI en changeant la syntaxe YAML. Trois
  transpositions : GitLab CI, Bitbucket Pipelines, Jenkins.
draft: false
---
