...
<Info title="Annexe de la série PrestaFlow. Prérequis : avoir lu « Écrire son premier scénario de test avec PrestaFlow ». On reprend le module fil rouge PrestaEdit/psflowdemo." />

## Rappel

Dans l'[article d'introduction](/2026/07/29/ecrire-son-premier-scenario-prestaflow/), nous avons créé une seule Page pour `psflowdemo`, avec deux méthodes :
