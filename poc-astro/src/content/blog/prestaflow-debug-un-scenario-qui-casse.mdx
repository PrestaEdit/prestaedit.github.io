...
- **Le stack trace** dans la sortie CLI (ou dans la vue résultat de l'app, cf. [article 3](/blog/piloter-ses-tests-depuis-l-application-prestaflow/)). Nom de la classe, ligne, message d'exception.
...
- Une capture visuelle qui diffère de la baseline sans que l'assertion ne tombe : c'est le sujet de l'[annexe régressions visuelles](/blog/prestaflow-regressions-visuelles/).
