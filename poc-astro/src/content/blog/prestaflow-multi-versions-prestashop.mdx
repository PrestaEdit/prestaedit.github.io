...
Dernier point : une boutique Flashlight neuve n'a aucun moyen de paiement actif. Une suite qui passe commande, comme `Checkout` dans psflowdemo, s'arrête à l'étape de paiement, sur les trois versions. Activez un module de paiement dans un init-script, ou lancez un dossier de suites qui n'en contient pas.
