...
author: PrestaEdit
series: prestaflow
featuredimg: 'https://prestaedit.github.io/head/2026-09-25-prestaflow-screenshots-pour-la-doc.svg'
...
- **[Fixtures](/blog/prestaflow-fixtures-seed-data/)** — vos captures montrent un produit à 9,99€ ? Fixez-le en seed pour qu'il soit toujours à 9,99€, pas au dernier prix modifié à la main.
- **[Cookies pré-injectés](/blog/prestaflow-auth-cookies-pre-injectes/)** — sautez le `it` de login pour aller directement à l'écran à documenter. Trois secondes gagnées par capture.
- **[Multi-locales](/blog/prestaflow-scenarios-multi-locales/)** — bouclez sur `PRESTAFLOW_LOCALE` pour générer `guide-fr/*.png` + `guide-en/*.png` en une commande. Votre doc multilingue reste alignée.
