...
<Info title="Fin du triptyque">
  Cet article ferme le triptyque des articles piliers ouvert par « Écrire son premier scénario » et « Automatiser ses scénarios en CI ». Il reprend le module fil rouge [PrestaEdit/psflowdemo](https://github.com/PrestaEdit/psflowdemo).
</Info>
...
* [**Article 1**](/blog/ecrire-son-premier-scenario-prestaflow/) — la librairie PHP : on écrit ses scénarios et on les lance à la main avec `./vendor/bin/prestaflow run`.
