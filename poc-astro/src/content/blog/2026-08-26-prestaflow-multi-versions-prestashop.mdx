...
author: PrestaEdit
series: prestaflow
featuredimg: 'https://prestaedit.github.io/head/2026-08-26-prestaflow-multi-versions-prestashop.svg'
summary: "Structurer ses Pages custom pour survivre à plusieurs versions majeures de PrestaShop, exécuter la même suite contre chacune, gérer les pièges classiques d'un passage 1.7 à 9."
---
...
- l'[annexe *Factoriser ses Pages*](/2026/08/05/prestaflow-factoriser-ses-pages/) a introduit la mécanique `Pages/v7/v8/v9/` en cinq lignes ;
- l'[article 2 sur la CI](/2026/07/30/automatiser-ses-scenarios-prestaflow-en-ci/) a montré la matrice `strategy.matrix.ps-version` qui lance la même suite contre plusieurs images Flashlight.
